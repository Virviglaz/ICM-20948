# ICM-20948 with DMP
## ICM-20948 library with DMP support
### Both I2C and SPI interfaces supported
...
## Output:
```
Accelerometer: ax=-0.01 g, ay=-0.00 g, az=-0.01 g
Gyroscope: gx=0.33 °/s, gy=-0.50 °/s, gz=-0.01 °/s
Temperature: 31.45 °C

Roll: -1.90°, Pitch: -1.57°, Yaw: 2.57°
Gyro: gx=0.63 °/s, gy=-1.42 °/s, gz=-0.02 °/s
Linear Acceleration: ax=-0.05 m/s², ay=0.01 m/s², az=-0.06 m/s²
```

Note: This project depends on my personal library collection providing interface classes for I2c and SPI buses and I2c/SPI devices.
This library doesn't not use any platform specific code and compatible with little and big-endian hardware.

### How to use
```
1. Clone this repo
$ https://github.com/Virviglaz/ICM-20948.git
